...
;**************************** Padding and Signature **********************************
      ...
      ; Now I need to store the information in the first part of the partition table 
      db 0x80           ; The first partition will be bootable 
      db 0              ; The starting head number 
      db 1              ; the starting sector number 
      db 0              ; The starting cylinder number 
      db 0x83           ; THe system ID of Lunix
      db 255            ; end the head number 
      db 0xFFFF          ; the end of sector number 
      db 0x400
      dd 0x1              ; the LBA number 
      dd 0x3f                ; the number of sectors
      times 48 db 0
